...
def main():
    ...
    print("\n📍 欢迎访问 CEP 网页控制台:")
    print(f"  - 目标资产配置: http://<你的服务器 IP>:{args.port}/")
    print(f"  - 净入金流程:   http://<你的服务器 IP>:{args.port}/fund-inflow.html")
    print("  - 行情通道: Redis Pub/Sub (已接入 Market Node 实时行情)\n")

    # 绑定 0.0.0.0 以便外网或物理机能够访问
