...
def make_momentum_bars(symbol: str) -> list[BarEvent]:
    ...
    closes = [
        100.0, 99.8, 100.1, 99.9, 100.2, 100.0, 100.3, 100.1, 100.4, 100.2,
        100.5, 100.3, 100.6, 100.4, 100.7, 100.5, 100.8, 100.6, 100.9, 100.7,
        101.0, 101.8, 102.7, 103.5, 104.4, 105.2, 106.1, 107.0,
    ]
