...
CREATE TABLE IF NOT EXISTS pending_orders (
    ...
    fractional_part DECIMAL(12, 6) NOT NULL COMMENT '本次待调余量部分（小数）',
    previous_fractional DECIMAL(12, 6) NOT NULL DEFAULT 0.000000 COMMENT '上次待调余量（从fractional_shares读取，用于本次计算）',
